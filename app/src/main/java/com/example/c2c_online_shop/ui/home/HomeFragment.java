...
public class HomeFragment extends Fragment {
    ...
    EditText order_qty;
    Button back_btn, order_btn;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //--------------------set View--------------------//
        MainActivity.fragmentName = "HomeFragment";
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            inProgress();
            new GetProductListTask().execute("https://linziyou.nctu.me:7777/api/c2c_shop/select/products");
        ...
        //--------------------Listener Observe--------------------//
        homeViewModel.getOrderQty().observe(this, s -> {
        ...
        order_qty.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                homeViewModel.setOrderQty(s.toString());
            }
        });
    ...
    private void order(){
        MainActivity.temp_od = MainActivity.temp_pd.createOrder(Integer.parseInt(homeViewModel.getOrderQty().getValue()));
    ...
    private class GetProductListTask extends AsyncTask<String, Void, String> {
        ...
        public void processGetProductList(String json){
            ...
            productRecyView.setAdapter(new HomeFragment.productItemAdapter(getContext(),
            ...
            productRecyView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    if(newState == RecyclerView.SCROLL_STATE_IDLE){
                        ...
                        HomeFragment.productItemAdapter adapter = (HomeFragment.productItemAdapter)recyclerView.getAdapter();
    ...
    private class productItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == NORMAL_ITEM) {
                ...
                holder = new HomeFragment.productItemAdapter.NormalViewHolder(view);
            } else {
                view = LayoutInflater.from(context).inflate(R.layout.recycler_has_more, parent, false);
                holder = new HomeFragment.productItemAdapter.FootViewHolder(view);
            }
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof HomeFragment.productItemAdapter.NormalViewHolder) {
                ...
                ((HomeFragment.productItemAdapter.FootViewHolder) holder).tips.setText((hasMore)? "Loading...": "Last one");
            }
        }
